...
// //         if (arr[i] > max)
// //         {
// //             max = arr[i]; // Cập nhật giá trị lớn nhất nếu tìm thấy phần
// tử lớn hơn
// //         }
// //     }
// //     return max;
...
//     cout << "tt     |     |     n";
//     cout << "tt  " << board[0][0] << "  | " << board[0][1] << "  |  " <<
//     board[0][2] << " n"; cout << "tt_____|_____|_____n"; cout << "tt     | |
//     n"; cout << "tt  " << board[1][0] << "  | " << board[1][1] << "  |  " <<
//     board[1][2] << " n"; cout << "tt_____|_____|_____n"; cout << "tt     | |
//     n"; cout << "tt  " << board[2][0] << "  | " << board[2][1] << "  |  " <<
//     board[2][2] << " n"; cout << "tt     |     |     n";
// }
...
// // Function to get the game status e.g. GAME WON, GAME DRAW GAME IN CONTINUE
// MODE
